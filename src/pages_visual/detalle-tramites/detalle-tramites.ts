...
private importancias: Record<string, string> = {
  ...
  'cartilla':      'No tramitarla antes de los 40 años puede resultar en arresto de 15 a 45 días o multa. Quedas bloqueado para empleos en gobierno, fuerzas armadas y para obtener pasaporte.Remisos: Personas de 18 a 39 años que no obtuvieron su cartilla al cumplir los 18 deben presentar una constancia emitida por la Junta de Reclutamiento de su lugar de nacimiento que certifique que no se les ha expedido el documento. ',
